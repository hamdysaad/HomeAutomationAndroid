...
public class AssignDeviceToUserDialog extends DialogFragment{
    ...
    public TextView userErrValidationTV;
    ...
    public static AssignDeviceToUserDialog newInstance(DeviceModel model){


        AssignDeviceToUserDialog dialog = new AssignDeviceToUserDialog();
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, Bundle savedInstanceState) {
         ...
         view = inflater.inflate(R.layout.assign_device_to_user_dialog , container , false);

        getDialog().setTitle("ASSIGN DEVICE TO USER");

        getDialog().getWindow().setLayout(ViewGroup.LayoutParams.WRAP_CONTENT , ViewGroup.LayoutParams.WRAP_CONTENT);

        initViews();

        AssignDeviceToUserDialogController controller = new AssignDeviceToUserDialogController(this);
    ...
    public void initViews() {
        ...
        usersSP =  (Spinner)view.findViewById(R.id.addDeviceDialog_spinnerUsers_sp);
        userErrValidationTV =  (TextView)view.findViewById(R.id.usersErrorValidation);
        usersRV =  (RecyclerView)view.findViewById(R.id.recyclarView);
        LinearLayoutManager mLayoutManager = new LinearLayoutManager(getActivity());
        usersRV.setLayoutManager(mLayoutManager);
        mProgressBar =  (ProgressBar)view.findViewById(R.id.progressBar);
        assignBtn =  (Button)view.findViewById(R.id.assignDeviceToUSerDialog_assign_btn);
    ...
    public static void showDialog(Activity activity, DeviceModel model){
        ...
        AssignDeviceToUserDialog addDeviceDialog = AssignDeviceToUserDialog.newInstance(model);
